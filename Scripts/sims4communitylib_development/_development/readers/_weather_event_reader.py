...
def _common_log_weather_events_ready_for_update(output: CommonConsoleCommandOutput) -> None:
    ...
    not_found_values = _S4CLEnumValueUpdateUtils()._read_values_from_instance_types(Types.WEATHER_EVENT, _S4CLReaderForUpdate.CONVERSIONS, CommonWeatherEventId, skip_not_found=True)
