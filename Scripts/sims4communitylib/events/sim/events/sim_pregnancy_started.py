...
class S4CLSimPregnancyStartedEvent(CommonEvent):
    """S4CLSimPregnancyStartedEvent(sim_info)
    ...
    :param sim_info: The info of a Sim that had a pregnancy started.
    ...
    def sim_info(self) -> SimInfo:
        ...
        :return: The info of the Sim that started pregnancy.
        :rtype: SimInfo
        """
