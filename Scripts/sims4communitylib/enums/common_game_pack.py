...
class CommonGamePack(CommonInt):
    ...
    SPONGEBOB_HOUSE_KIT: 'CommonGamePack' = 0x6D  # SP68
    AUTUMN_APPAREL_KIT: 'CommonGamePack' = 0x6E  # SP69
    SPONGEBOB_KIDS_ROOM_KIT: 'CommonGamePack' = 0x6F  # SP70
    GRANGE_MUDROOM_KIT: 'CommonGamePack' = 0x70  # SP71
    ESSENTIAL_GLAM_KIT: 'CommonGamePack' = 0x71  # SP72
    MODERN_RETREAT_KIT: 'CommonGamePack' = 0x72  # SP73
    GARDEN_TO_TABLE_KIT: 'CommonGamePack' = 0x73  # SP74
    PRAIRIE_DREAMS_KIT: 'CommonGamePack' = 0x7A  # SP81
