...
class CommonGamePackUtils:
    ...
    def has_game_packs_available(game_packs: Tuple[Union[CommonGamePack, Pack]]) -> bool:
        ...
        Determine if specified Game Packs are available.

        :param game_packs: The Game Packs to check for.
        :type game_packs: Tuple[Union[CommonGamePack, Pack]]
        :return: True, if all the specified Game Packs are available. False, if any of them are not available.
        :rtype: bool
        """
    ...
    def get_available_game_packs() -> Tuple[Union[CommonGamePack, Pack], ...]:
        ...
        return tuple([CommonGamePack.convert_from_vanilla(pack) for pack in get_available_packs()])
    ...
    def get_game_pack_name(game_pack: Union[CommonGamePack, Pack]) -> str:
        ...
        vanilla_pack = CommonGamePack.convert_to_vanilla(game_pack)
        return get_pack_name(vanilla_pack)
