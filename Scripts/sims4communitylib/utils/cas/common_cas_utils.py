...
class CommonCASUtils(_HasS4CLClassLog):
    ...
    def detach_cas_parts_from_outfit_of_sim(cls, sim_info: SimInfo, cas_parts: Iterator[CommonCASPart], outfit_category_and_index: Tuple[OutfitCategory, int] = None) -> bool:
        ...
        existing_outfit_data = sim_info.get_outfit(outfit_category_and_index[0], outfit_category_and_index[1])
        if existing_outfit_data is None:
            cls.get_log().format_with_message('No current outfit on the Sim', sim=sim_info, current_outfit=outfit_category_and_index)
            return False
...
@CommonConsoleCommand(
    ModInfo.get_identity(),
    's4clib.reset_bathing_outfit',
    'Reset the bathing outfit of a Sim, removing any extra parts and applying the correct bathing outfit parts.',
    command_arguments=(
            CommonConsoleCommandArgument('sim_info', 'Sim Id or Name', 'The Sim to update.', is_optional=True, default_value='Active Sim'),
    ),
)
def _common_reset_bathing_outfit(output: CommonConsoleCommandOutput, sim_info: SimInfo = None):
    if sim_info is None:
        output('ERROR: No Sim was specified or the specified Sim was not found!')
        return
    output(f'Attempting to reset bathing outfit for {sim_info}')
    from sims4communitylib.enums.common_age import CommonAge
    bathing_outfit_parts_by_age_and_species = {
        CommonSpecies.HUMAN: {
            CommonAge.ADULT: {
                CommonGender.MALE: {
                    CommonBodySlot.HEAD: 0x0000229C,
                    CommonBodySlot.UPPER_BODY: 0x000019A2,
                    CommonBodySlot.LOWER_BODY: 0x000019AE,
                    CommonBodySlot.SHOES: 0x000019A3,
                },
                CommonGender.FEMALE: {
                    CommonBodySlot.HEAD: 0x00001B41,
                    CommonBodySlot.UPPER_BODY: 0x0000198C,
                    CommonBodySlot.LOWER_BODY: 0x00001990,
                    CommonBodySlot.SHOES: 0x0000198F,
                }
            },
            CommonAge.CHILD: {
                CommonGender.MALE: {
                    CommonBodySlot.HEAD: 0x00006CA8,
                    CommonBodySlot.UPPER_BODY: 0x00005635,
                    CommonBodySlot.LOWER_BODY: 0x0000563A,
                    CommonBodySlot.SHOES: 0x00005602,
                },
                CommonGender.FEMALE: {
                    CommonBodySlot.HEAD: 0x00006CA8,
                    CommonBodySlot.UPPER_BODY: 0x0000F3BA,
                    CommonBodySlot.LOWER_BODY: 0x0000563A,
                    CommonBodySlot.SHOES: 0x00005602,
                }
            },
            CommonAge.TODDLER: {
                CommonGender.MALE: {
                    CommonBodySlot.HEAD: 0x000206C9,
                    CommonBodySlot.UPPER_BODY: 0x000206C7,
                    CommonBodySlot.LOWER_BODY: 0x000206CC,
                    CommonBodySlot.SHOES: 0x0000206D2,
                },
                CommonGender.FEMALE: {
                    CommonBodySlot.HEAD: 0x000206C9,
                    CommonBodySlot.UPPER_BODY: 0x000206C7,
            ...
            CommonAge.INFANT: {
                CommonGender.MALE: {
                    CommonBodySlot.HEAD: 0x00045580,
                    CommonBodySlot.UPPER_BODY: 0x00045585,
                    CommonBodySlot.LOWER_BODY: 0x00045587,
                    CommonBodySlot.SHOES: 0x00045588,
                },
                CommonGender.FEMALE: {
                    CommonBodySlot.HEAD: 0x00045580,
                    CommonBodySlot.UPPER_BODY: 0x00045585,
        ...
        CommonSpecies.LARGE_DOG: {
            CommonAge.ADULT: {
                CommonGender.MALE: {
                    CommonBodySlot.HEAD: 0x0001E945,
                    CommonBodySlot.FULL_BODY: 0x0001E941,
                    CommonBodySlot.SHOES: 0x0001E943,
                },
                CommonGender.FEMALE: {
                    CommonBodySlot.HEAD: 0x0001E945,
                    CommonBodySlot.FULL_BODY: 0x0001E941,
            ...
            CommonAge.CHILD: {
                CommonGender.MALE: {
                    CommonBodySlot.HEAD: 0x0002695C,
                    CommonBodySlot.FULL_BODY: 0x00026955,
                    CommonBodySlot.SHOES: 0x0002695E,
                },
                CommonGender.FEMALE: {
                    CommonBodySlot.HEAD: 0x0002695C,
                    CommonBodySlot.FULL_BODY: 0x00026955,
        ...
        CommonSpecies.SMALL_DOG: {
            CommonAge.ADULT: {
                CommonGender.MALE: {
                    CommonBodySlot.HEAD: 0x00024565,
                    CommonBodySlot.FULL_BODY: 0x00024563,
                    CommonBodySlot.SHOES: 0x00024567,
                },
                CommonGender.FEMALE: {
                    CommonBodySlot.HEAD: 0x00024565,
                    CommonBodySlot.FULL_BODY: 0x00024563,
        ...
        CommonSpecies.CAT: {
            CommonAge.ADULT: {
                CommonGender.MALE: {
                    CommonBodySlot.HEAD: 0x00024B87,
                    CommonBodySlot.FULL_BODY: 0x00024B48,
                    CommonBodySlot.SHOES: 0x00024B5F,
                },
                CommonGender.FEMALE: {
                    CommonBodySlot.HEAD: 0x00024B87,
                    CommonBodySlot.FULL_BODY: 0x00024B48,
            ...
            CommonAge.CHILD: {
                CommonGender.MALE: {
                    CommonBodySlot.HEAD: 0x00028112,
                    CommonBodySlot.FULL_BODY: 0x000280EE,
                    CommonBodySlot.SHOES: 0x0002810F,
                },
                CommonGender.FEMALE: {
                    CommonBodySlot.HEAD: 0x00028112,
                    CommonBodySlot.FULL_BODY: 0x000280EE,
        ...
        CommonSpecies.FOX: {
            CommonAge.ADULT: {
                CommonGender.MALE: {
                    CommonBodySlot.HEAD: 0x0004197F,
                    CommonBodySlot.FULL_BODY: 0x0004196F,
                    CommonBodySlot.SHOES: 0x00043BF4,
                },
                CommonGender.FEMALE: {
                    CommonBodySlot.HEAD: 0x0004197F,
                    CommonBodySlot.FULL_BODY: 0x0004196F,
        ...
        CommonSpecies.HORSE: {
            CommonAge.ADULT: {
                CommonGender.MALE: {
                    CommonBodySlot.HEAD: 0x00050F2A,
                    CommonBodySlot.FULL_BODY: 0x000524F3,
                    CommonBodySlot.SHOES: 0x000524F4,
                },
                CommonGender.FEMALE: {
                    CommonBodySlot.HEAD: 0x00050F2A,
                    CommonBodySlot.FULL_BODY: 0x000524F3,
            ...
            CommonAge.CHILD: {
                CommonGender.MALE: {
                    CommonBodySlot.HEAD: 0x00053D9C,
                    CommonBodySlot.FULL_BODY: 0x00053D9F,
                    CommonBodySlot.SHOES: 0x00053DA1,
                },
                CommonGender.FEMALE: {
                    CommonBodySlot.HEAD: 0x00053D9C,
                    CommonBodySlot.FULL_BODY: 0x00053D9F,
    ...
    if age in (CommonAge.TEEN, CommonAge.ADULT, CommonAge.YOUNGADULT, CommonAge.ELDER):
        age = CommonAge.ADULT

    if species not in bathing_outfit_parts_by_age_and_species:
        output(f'No bathing parts found for species {species.name}')
        return
    species_value = bathing_outfit_parts_by_age_and_species[species]
    if age not in species_value:
        output(f'No bathing parts found for age {age.name} and species {species.name}')
        return
    age_value = species_value[age]
    if gender not in age_value:
        output(f'No bathing parts found for gender {gender.name}, age {age.name}, and species {species.name}')
        return
    bathing_parts_by_body_location = age_value[gender]
    for (body_slot, cas_part_id) in bathing_parts_by_body_location.items():
        CommonCASUtils.attach_cas_part_to_outfit_of_sim(sim_info, CommonCASPart(cas_part_id, body_slot), (OutfitCategory.BATHING, 0))
    output(f'Done resetting the bathing outfit for Sim {sim_info}.')
