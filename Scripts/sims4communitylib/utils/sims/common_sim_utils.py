...
class CommonSimUtils:
    ...
    @classmethod
    def get_sim_id(cls, sim_identifier: Union[int, Sim, SimInfo, SimInfoBaseWrapper, ScriptObject]) -> int:
        ...
        :type sim_identifier: Union[int, Sim, SimInfo, SimInfoBaseWrapper, ScriptObject]
    ...
    def get_sim_info(
        cls,
        sim_identifier: Union[int, Sim, SimInfo, SimInfoBaseWrapper, ScriptObject]
