...
def _common_keep_original_sim_info_around(original, self, *_, **__) -> None:
    ...
    def _fixed_modify_sim_info(source_sim_info: Union[SimInfo, SimInfoBaseWrapper], modified_sim_info: SimInfoBaseWrapper, *_, **__) -> BodyTypeFlag:
        ...
        return original_modify_sim_info(source_sim_info, modified_sim_info, *_, **__)
