...
To start creating mods using S4CL [check out the template project](https://github.com/DeviantGameMods/s4cl-template-project)!
...
- Download the latest zip archive from the [releases](https://github.com/DeviantGameMods/Sims4CommunityLibrary/releases) page (It is the one with the version number in it Example: sims4communitylib.v0.0.0.zip) (Ignore the ones that say Source Code)
...
- Create a project based off of the [Template Project](https://github.com/DeviantGameMods/s4cl-template-project)
- Use the green button in the top right [The Main Page](https://github.com/DeviantGameMods/Sims4CommunityLibrary) to download this project as a zip file.
...
- In order to prevent users from accidentally installing multiple copies of S4CL into their Mods folder, it is preferred to redirect the users of your mod to download S4CL from either the [github repository](https://github.com/DeviantGameMods/Sims4CommunityLibrary) or [releases](https://github.com/DeviantGameMods/Sims4CommunityLibrary/releases) pages instead of bundling it with your mod.
