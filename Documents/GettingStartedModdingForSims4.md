...
- Alternative to Git, you can download the source files from [the latest release](https://github.com/DeviantGameMods/Sims4CommunityLibrary/releases).
...
- Create a repository based off of the [Template Project](https://github.com/DeviantGameMods/s4cl-template-project) by pulling the Template down to your Machine and pushing the code to a new repository.
...
- YOU DO NOT HAVE MY PERMISSION TO BUNDLE S4CL INTO YOUR OWN MOD. So don't do it. Redirect the users of your mod to the [github repository](https://github.com/DeviantGameMods/Sims4CommunityLibrary) or [releases](https://github.com/DeviantGameMods/Sims4CommunityLibrary/releases) pages instead.